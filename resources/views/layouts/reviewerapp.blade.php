                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        <ul class="navbar-nav mr-auto">
                            ...
                            @auth
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('review') }}">{{ __('app.review') }}</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('conferences') }}">{{ __('app.submissions') }}</a>
                            </li>
                            @endauth
                            <!--
                            <li class="nav-item">
                        ...
                        <ul class="navbar-nav ml-auto">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                    <a class="dropdown-item" href="{{ route('editProfileRewiever') }}">
                                        {{ __('app.edit_profile') }}
                                    </a>
